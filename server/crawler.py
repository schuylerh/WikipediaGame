...
def get_links(page_url, start_page, finish_page, category_dict, keywords):
    ...
    try:
        ...
        links = [link for link in all_links if re.match(r'^https://en\.wikipedia\.org/wiki/[^:]*$', link) and '#' not in link and link != "https://en.wikipedia.org/wiki/ISBN_(identifier)" and link != "https://en.wikipedia.org/wiki/ISSN_(identifier)"]
